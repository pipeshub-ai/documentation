...
Each team's stories are the demo data behind a [Build Pack](https://github.com/pipeshub-ai/examples/tree/main/packs) in the examples repository: instructions for Claude Code, Codex, Cursor and Omnigent, the questions to ask, and the records a good answer cites. The [Engineering pack](https://github.com/pipeshub-ai/examples/tree/main/packs/engineering) is published; the Sales, Support, Marketing, Finance and People packs are being added. Try a pack here before pointing it at your own tools.
