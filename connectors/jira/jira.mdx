...
4. In the **"Who can see this?"** dropdown for your email address, select either:
...
<Accordion title="Why are comments or attachments missing from search?">
  Check that indexing filters for comments and attachments are enabled, and confirm the authenticating user has permission to view those items in Jira. After toggling filters, run a sync to refresh indexed content.
</Accordion>
