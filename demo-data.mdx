...
| Person | Groups | Sees |
| --- | --- | --- |
| **Alice Chen** (`alice@acme-demo.example`) | every team's readers group, plus **launch core** and **payments contracts** | every team's folders, the embargoed next-launch brief and the payment processing agreement |
...
Each team's stories are the demo data behind a [Build Pack](https://github.com/pipeshub-ai/examples) in the examples repository: instructions for Claude Code, Codex, Cursor and Omnigent, the questions to ask, and the records a good answer cites. Try a pack here before pointing it at your own tools.
