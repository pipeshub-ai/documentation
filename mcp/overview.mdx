...
- A running PipesHub instance (self-hosted or cloud). If they have none yet, follow [No instance yet](/for-agents#no-instance-yet-local-demo) instead of scaffolding LangChain.
