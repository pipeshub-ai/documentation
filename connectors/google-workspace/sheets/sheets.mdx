...
<div className="not-prose mt-10">
  <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl bg-blue-50 dark:bg-gray-800">
    <div className="flex items-center gap-3 mb-4">
      ...
      />
      <div className="text-xl font-semibold text-gray-900 dark:text-white">Google Sheets</div>
    </div>
...
<Note>
  Google Sheets is not a standalone connector currently. Spreadsheets in Google Sheets stored in Drive are synced through the [Google Drive](/connectors/google-workspace/drive/drive) connector. Use the **Sync Files with Extensions** sync filter on the Drive "Configure Records" page to sync only spreadsheets.
</Note>
...
<Info>
  The "In" operator syncs only the extensions you select. If you leave **Sync Files with Extensions** unset, Drive will sync every file type, including spreadsheets.
</Info>
