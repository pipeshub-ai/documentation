...
| Connector    | Description |
|--------------|-------------|
| **Jira Cloud** | Issue tracking, project management, and agile workflows |
| **Jira Data Center** | Issue tracking and project management for self-hosted Jira |
| **Confluence Cloud** | Team collaboration and knowledge base management |
| **Confluence Data Center** | Team collaboration and knowledge base for self-hosted Confluence |
...
| **GitLab** | Version control, code collaboration, and merge request tracking |
| **Linear** | Modern issue tracking and project management |
| **Notion** | Pages, databases, and files — team (workspace-wide search) or personal (only you) |
