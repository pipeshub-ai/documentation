...
- Syncs every attachment of a page, however many it has. If the attachment list stops partway, the attachments already read are kept and the space is read again on the next sync to pick up the rest
