...
<Note>
  Sharing never moves a file. A file or folder owned by someone in your Box enterprise stays in its owner's drive, in its place in the owner's folders, and the colleagues it is shared with see it under **Shared with me**. Items owned by someone outside your enterprise appear only under **Shared with me**.
</Note>
