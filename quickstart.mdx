...
<Tip>
  Coding agent standing this up for a user who has no PipesHub yet? Follow [For coding agents](/for-agents#no-instance-yet-local-demo). Do not scaffold LangChain. First-run (account + LLM) stays in the browser.
</Tip>
