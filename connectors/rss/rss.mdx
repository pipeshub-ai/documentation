...
For **team** scope, synced records are readable by everyone in your organization. For **personal** scope, the user who created the connector is set as **owner**; if creator metadata isn't available, the connector falls back to organization-level read access.
