...
- `gpt-5` - OpenAI's latest and most advanced model with improved capabilities.
- `gpt-5-mini` - Faster, more cost-effective option for many use cases.
- `gpt-5-nano` - Fastest, most cost-efficient version of GPT-5
- `gpt-4.1` - OpenAI's smartest non-reasoning model for complex tasks. It is well suited for problem solving across domains.
...
- For complex reasoning tasks and problem-solving, select `o3` or `o3-mini`
- For general advanced features, select `gpt-4o` or `gpt-4.1`
