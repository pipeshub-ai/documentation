...
<Tip>
  Coding agents standing up a **laptop demo**: follow [For coding agents](/for-agents#no-instance-yet-local-demo), then use the [stdio bridge](#option-2-local-stdio-bridge) below. Do not point Claude Desktop's custom connector at localhost.
</Tip>
