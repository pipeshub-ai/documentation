...
2. Find the **Zammad** connector and click **"Save Configuration"**
3. The configuration dialog will appear with authentication settings

<Warning>
  **Important:** Generate the API token from a Zammad account that uses the same email address as your PipesHub account. Using a different email will cause permission issues on the PipesHub platform.
</Warning>
...
1. After saving the authentication settings, click **"Enable Sync"** to activate the connector
