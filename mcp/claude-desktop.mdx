...
<Tip>
  Coding agents standing up a **laptop demo**: follow [Local Docker demo](/for-agents-local-demo), then use the [stdio bridge](#option-2-local-stdio-bridge) below. Do not point Claude Desktop's custom connector at localhost.
</Tip>
