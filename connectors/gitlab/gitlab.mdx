...
get a 401 together, they share that one refresh, so refresh tokens aren't used up needlessly. Other
errors never trigger a refresh, even if their text happens to contain "401".
