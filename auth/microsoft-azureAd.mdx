...
description: "Configure how users authenticate and access the application through Microsoft and Azure AD"
icon: "microsoft"
---
...
1. Register your application in the [Microsoft Azure Portal](https://portal.azure.com/):
   ...
   <div style={{ textAlign: "center" }}>
     <img
       src="/images/auth/saml/microsoft/entra_app.png"
...
3. In PipesHub:
   ...
   <div style={{ textAlign: "center" }}>
     <img
       src="/images/auth/saml/microsoft/pipeshub_microsoft_setup.png"
