...
<div className="not-prose mt-10">
  <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl bg-blue-50 dark:bg-gray-800">
    <div className="flex items-center gap-3 mb-4">
      ...
      />
      <div className="text-xl font-semibold text-gray-900 dark:text-white">Jira Cloud Toolset</div>
    </div>
    <p className="text-base text-gray-700 dark:text-gray-300 mt-0 mb-5">Issue tracking, project management, and team collaboration</p>
...
<Info>
  This page is for **Jira Cloud**, the version Atlassian hosts for you. If you run Jira on your own servers, use the [Jira Data Center toolset](/toolsets/jira/jira-data-center) instead.
</Info>
...
<div className="text-center">
  <img
    ...
    alt="Enter Client ID and Client Secret in PipesHub"
    className="block mx-auto w-11/12"
  />
</div>
