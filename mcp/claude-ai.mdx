...
<Warning>
  Claude.ai needs **public HTTPS**. It cannot attach to `http://localhost:.../mcp`. A laptop demo is [For coding agents](/for-agents#no-instance-yet-local-demo) plus Cursor / Claude Code / the stdio bridge — not this page.
</Warning>
