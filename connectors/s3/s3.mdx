...
3. **Download or Copy Credentials:**
   ...
   - **Secret Access Key**: Click **"Show"** and copy this value immediately
...
4. **Download Credentials (Optional):**
   - Click **"Download .csv file"** to save credentials to a secure location
...
- **Recent files only**: Modified Date → Operator: `Is After`, Date: `2024-06-01`
...
1. Connector reads the sync point for each bucket (stored in ArangoDB)
