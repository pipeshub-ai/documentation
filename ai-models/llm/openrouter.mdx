...
**Important:** Use the exact model identifier as shown on OpenRouter's model page (e.g., `openai/gpt-4o`, not just `gpt-4o`).
...
- Use appropriate models for your use case (don't use GPT-4o when GPT-4o-mini suffices)
