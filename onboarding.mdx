...
### For more info, refer to [Storage Service documentation](/system-overview/storage).
...
For more information, refer to [the Google Drive connector guide](/connectors/google-workspace/drive/drive).
...
Click **Save** to finalize the setup and then proceed.
