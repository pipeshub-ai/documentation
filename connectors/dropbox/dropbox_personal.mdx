...
<div className="not-prose mt-10">
  <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl bg-blue-50 dark:bg-gray-800">
    <div className="flex items-center gap-3 mb-4">
      <img src="/logo/dropbox.png" alt="Dropbox Personal Logo" className="w-8 h-8 object-contain flex-shrink-0" />
      <div className="text-xl font-semibold text-gray-900 dark:text-white">Dropbox Personal</div>
    </div>
    <p className="text-base text-gray-700 dark:text-gray-300 mt-0 mb-5">Sync files and folders from individual accounts</p>
...
<img src="/images/connectors/dropbox/db1.png" alt="Dropbox Create App" style={{ display: 'block', margin: '0 auto' }} width="90%" />
...
<img src="/images/connectors/dropbox/db2.png" alt="Dropbox Permissions" style={{ display: 'block', margin: '0 auto' }} width="90%" />
...
<img src="/images/connectors/dropbox/dbp1.png" alt="Dropbox Redirect URI" style={{ display: 'block', margin: '0 auto' }} width="90%" />
...
3. Search for the **Dropbox** connector and click on **Setup** to configure a connector instance.
...
4. In the configuration dialog that opens:
  ...
  <div style={{ textAlign: "center" }}>
       <img
         src="/images/connectors/dropbox/dropbox_personal_configuration.png"
         alt="Dropbox Configuration"
         width="90%"
       />
     </div>
...
1. In the Authorize page that opens:
  ...
  <div style={{ textAlign: "center" }}>
    <img
      src="/images/connectors/dropbox/dropbox_personal_consent_screen.png"
      alt="Dropbox consent screen for Dropbox connector"
      width="90%"
    />
  </div>
...
<div style={{ textAlign: "center" }}>
     <img
       src="/images/connectors/dropbox/dropbox_filters_example.png"
       alt="Dropbox Configuration"
       width="90%"
     />
</div>
