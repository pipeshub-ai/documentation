...
<Info>
  Looking to perform actions like sending emails or creating tickets? You need [**Toolsets**](/toolsets/overview) instead. Toolsets enable agents to perform actions on data, not just search it.
</Info>
