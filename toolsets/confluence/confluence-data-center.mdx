...
<Warning>
  **You cannot use OAuth 2.0 with Confluence Data Center.** The OAuth apps you create in the Atlassian Developer Console only work with Confluence Cloud.
</Warning>
...
No. OAuth apps created in the Atlassian Developer Console only work with Confluence Cloud. This toolset supports **Personal Access Token** and **Basic Authentication** only.
