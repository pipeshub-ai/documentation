...
Ask your agent to "send an email to user@example.com" and provide the subject and message. The agent supports both plain text and HTML formatting.
...
**How do replies work?**  
Gmail automatically groups email replies into threads. When you reply to an email, it stays in the same conversation thread.
