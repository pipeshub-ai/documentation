...
### Query Service (Python FAST API Server)
...
### Indexing Service
Indexing servcice extract contents from various data sources and index it for search. These services process documents, extract metadata, and prepare data for storage in blob, vector and graph databases.
