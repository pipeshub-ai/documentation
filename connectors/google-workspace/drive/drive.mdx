...
**Run 5:** PipesHub moves on without the folder, the rest of the sync finishes, and its progress is saved. The sync logs name the folder and say what to check.
