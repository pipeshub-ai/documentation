...
<div className="not-prose mt-10">
  <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl bg-blue-50 dark:bg-gray-800">
    <div className="flex items-center gap-3 mb-4">
      ...
      />
      <div className="text-xl font-semibold text-gray-900 dark:text-white">Amazon S3</div>
    </div>
...
- **Files**: Supported file types stored in S3 buckets, including documents and images
...
<div className="text-center">
  <img
    src="/images/connectors/s3/authenticate_tab.png"
    alt="S3 Authenticate Instance tab in PipesHub"
    className="block mx-auto w-11/12"
  />
</div>
...
<div className="text-center">
  <img
    src="/images/connectors/s3/configure_tab.png"
    alt="S3 Configure Records tab in PipesHub — sync settings and filters"
    className="block mx-auto w-11/12"
  />
</div>
...
<div className="text-center">
  <img
    src="/images/connectors/s3/instance_card.png"
    alt="S3 instance card with Sync Paused and Sync Enabled toggle"
    className="block mx-auto w-11/12"
  />
</div>
...
<div className="text-center">
  <img
    src="/images/connectors/s3/instance_panel.png"
    alt="S3 instance Overview panel with Records Status and Records by Type"
    className="block mx-auto w-11/12"
  />
</div>
...
<Accordion title="Common Issues and Solutions" icon="circle-exclamation" defaultOpen>
...
3. Images can be content-indexed; check that other file types are supported for indexing
...
7. Ensure the file type is supported for content indexing
...
<Accordion title="What file types can be indexed for search?">
  The connector can index supported file types for AI-powered search:
  ...
  **Not Supported:**
  ...
  - Binary files without supported content extraction

  Supported images can be content-indexed for AI-powered search.
</Accordion>
