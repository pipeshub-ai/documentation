...
In **OAuth & Permissions**, scroll to **Scopes** and add the following under **Bot Token Scopes**.
...
| `users.profile:write` | Write user profiles (used by `set_user_status`) |
...
**Search, reactions, pins, user groups**
| Scope | Purpose |
|-------|---------|
