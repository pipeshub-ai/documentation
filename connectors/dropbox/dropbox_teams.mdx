...
<div className="not-prose mt-10">
  <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl bg-blue-50 dark:bg-gray-800">
    <div className="flex items-center gap-3 mb-4">
      ...
      />
      <div className="text-xl font-semibold text-gray-900 dark:text-white">Dropbox Teams</div>
    </div>
    <p className="text-base text-gray-700 dark:text-gray-300 mt-0 mb-5">Cloud storage and file sharing</p>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/images/connectors/dropbox/search_for_dropbox_connector.png"
    alt="Search for Dropbox connector"
    style={{ display: 'block', margin: '0 auto' }}
    width="90%"
  />
</div>
...
3. In the configuration dialog that opens:
   ...
   <div style={{ textAlign: "center" }}>
     <img
       src="/images/connectors/dropbox/dropbox_configuration.png"
...
1. In the Authorize page that opens:
   ...
   <div style={{ textAlign: "center" }}>
     <img
       src="/images/connectors/dropbox/dropbox_consent_screen.png"
...
Each workflow has an **Incremental component** which only fetches events that have occurred since last sync. For that we save a **'cursor'** for that event in the sync points collection in the graph database. e.g., `member_events`, `user_group_events`, `record_group_events`.
