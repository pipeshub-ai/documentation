...
3. **Redirect URI**: Get the Redirect URI from the PipesHub **Configure SharePoint** dialog in **Workspace → Actions** (where SharePoint is set up — for example **+ Setup** / **Configure**). Set the platform to **Web** and paste the value.
