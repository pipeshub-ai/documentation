...
1. Enter your **Client ID** and **Client Secret** (from the application's developer console)
2. Click **"Authenticate"**
3. A popup window will open for authorization
4. Grant the requested permissions
5. You'll be redirected back with authentication confirmed

<Info>
  See individual toolset documentation for specific authentication setup steps and requirements.
</Info>
