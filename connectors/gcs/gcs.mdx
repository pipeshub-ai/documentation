...
<div className="not-prose mt-10">
  <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl bg-blue-50 dark:bg-gray-800">
    <div className="flex items-center gap-3 mb-4">
      ...
      />
      <div className="text-xl font-semibold text-gray-900 dark:text-white">Google Cloud Storage</div>
    </div>
    <p className="text-base text-gray-700 dark:text-gray-300 mt-0 mb-5">Cloud object storage service</p>
...
- **Unsupported** — files it *can* store but can't content-index (videos, audio, archives, and other unsupported formats)
...
That's it — once **Not Started** and **Processing** both hit zero, all supported files are content-indexed and searchable in PipesHub. Unsupported files remain synced but aren't searchable by content.
...
3. Extracts supported file content so you can search it
...
<Accordion title="Troubleshooting" icon="circle-exclamation" defaultOpen>
...
**Initial sync is taking forever**
...
- Files showing as **Unsupported**? That's expected for unsupported formats such as videos, audio, and archives — they're stored but their content can't be indexed.
...
<Accordion title="How long does the initial sync take?" defaultOpen>
...
<Accordion title="Which file types can actually be searched?">
  **Searchable by content:**
  ...
  - E-books — EPUB, unless copy-protected (DRM); searchable, but not previewable
