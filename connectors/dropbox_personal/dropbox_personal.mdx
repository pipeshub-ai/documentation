...
3. Add the following URL to the **Redirect URIs** field (replace `{your_base_url}` with your actual domain): 
   ```
...
Click **Next**. You can setup your sync strategy: **Manual** or **Scheduled**. 
