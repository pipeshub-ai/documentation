...
### Step 7: Authenticate the toolset under Your actions
...
3. Give the agent a name, drag the **ClickUp** toolset onto the canvas, connect it to the **Agent** node with your model and chat input/output, then create the agent.
