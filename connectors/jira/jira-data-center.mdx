...
**People lose a project role's access on an instance with more than 1000 groups:**
...
- The first 1000 groups keep syncing. A project role that includes a group past the first 1000 keeps the members it already has in PipesHub, instead of losing the people who come through that group. Roles made only of users, or only of groups in the first 1000, sync as usual.
