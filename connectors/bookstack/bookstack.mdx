...
### BookStack API Token Generation and Usage
...
### Configure BookStack Connector in PipesHub
...
#### Step 3: Input Credentials
  - Set your sync stratergy as **Manual** or **Webhooks** (to be implemented)
...
## BookStack Connector Sync Workflow
...
**NOTE:** In BookStack, the "Shelf" is used only for organizing items and is not a parent of book.
...
Auto-generated comprehensive BookStack API client wrapper. Generated from BookStack API documentation at: [https://bookstack.bassopaolo.com/api/docs](https://bookstack.bassopaolo.com/api/docs)