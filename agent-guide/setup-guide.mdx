...
| **Starting Message** | Initial greeting when users start a conversation | "Hi! I can help you manage your projects. What would you like to do?" |
...
3. Click **"Save Chnages"** to apply the configuration
