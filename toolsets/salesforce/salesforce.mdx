...
1. In the Setup search bar, type **App Manager** and open **Lightning Experience App Manager**.
...
Your **Instance URL** is the base domain shown in your browser's address bar when you are in Salesforce — for example `https://yourcompany.develop.my.salesforce.com`. 
