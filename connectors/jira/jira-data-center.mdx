...
If Jira rate-limits the issue search, the connector waits as long as Jira asks, up to a minute, and tries again instead of skipping the project for that sync.
