...
## Step 2: Install App And Copy Credentials
...
## Step 3: Configure Slack Bot In Pipeshub Frontend

### Navigation

- **Workspace Settings** -> **Bots**
- Route path: `/workspace/bots`

### Add Bot Configuration

Click **Add Bot** then select **Slack Bot** and fill:
...
Click **Create** (or **Save** in edit mode).

<div style={{ textAlign: "center" }}>
     <img
       src="/images/integrations/slack-bot.png"
       alt="Slack bot configuration"
       width="90%"
     />
   </div>
